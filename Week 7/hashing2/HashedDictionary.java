...

{
    ...
    // We've added this method to display the hash table for illustration and
    // testing
    ...
    public V add(K key, V value) {
...

        {
...

            {
                ...
                // Ensure hash table is not too full

                double loadFactor = (double) (numberOfEntries + 1) / hashTable.length;
...

            {
                ...
                result = hashTable[index].getValue(); // Return value
