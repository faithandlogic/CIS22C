...
public class StackSort {
    ...
    int result[] = new int[data.length];
        StackInterface<Integer> originalStack = new LinkedStack<Integer>();
        StackInterface<Integer> tempStack = new LinkedStack<Integer>();
        // Put the data into the original stack
        for (int i = 0; i < data.length; i++) {
            originalStack.push(data[i]);
        }
        // Sort the data
        ...
        // Put the data back into the result array
        for (int i = 0; i < data.length; i++) {
